...
class POTW_Tabs extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'label' => __( 'Title & Description', 'potw' ),

				'type' => Controls_Manager::TEXT,

				'default' => __( 'Tab Title', 'potw' ),

				'placeholder' => __( 'Tab Title', 'potw' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Content', 'potw' ),

				'placeholder' => __( 'Tab Content', 'potw' ),
			...
			[
				...
				'default' => [
					...
					[
						...
						'tab_title' => __( 'Tab #1', 'potw' ),

						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'potw' ),

					],

					[

						'tab_title' => __( 'Tab #2', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Tabs() );