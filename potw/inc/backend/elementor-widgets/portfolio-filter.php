...
class POTW_PortfolioFilter extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Portfolio Filter', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'potw-portfolio-thumbnail-left-top',

				'options' => [					

					'potw-portfolio-thumbnail-left-top' => __( 'Default - 760 x 760', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Text Hover Color', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_PortfolioFilter() );