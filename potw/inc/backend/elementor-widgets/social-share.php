...
class POTW_SocialShare extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Social Share', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Social Share Buttons', 'potw' ),
				...
				'options' => [
					...
					'facebook' 		=> __( 'Facebook', 'potw' ),					

					'twitter' 		=> __( 'Twitter', 'potw' ),

					'google'  		=> __( 'Google Plus', 'potw' ),					

					'pinterest' 	=> __( 'Pinterest', 'potw' ),

					'linkedin'  	=> __( 'Linkedin', 'potw' ),					

					'buffer' 		=> __( 'Buffer', 'potw' ),

					'digg'  		=> __( 'Digg', 'potw' ),					

					'reddit' 		=> __( 'Reddit', 'potw' ),

					'tumbleupon'  	=> __( 'Tumbleupon', 'potw' ),					

					'tumblr' 		=> __( 'Tumblr', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'rounded'  => __( 'Rounded', 'potw' ),

					'square' => __( 'Square', 'potw' ),

					'circle' => __( 'Circle', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'default_color'  => __( 'Official Color', 'potw' ),

					'custom_color' => __( 'Custom', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_SocialShare() );