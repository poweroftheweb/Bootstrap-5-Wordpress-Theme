...
class POTW_Chart_Number extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Chart Number', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Before Active Color', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'After Active Color', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Chart_Number() );