...
class POTW_Progress_Bars extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Progress Bars', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'line'    => __( 'Style 1: Line', 'potw' ),

					'circle'  => __( 'Style 2: Circle', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Keyword Research', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label'   => esc_html__( 'Show Percentage', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Color 2(Gradient)', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Progress_Bars() );