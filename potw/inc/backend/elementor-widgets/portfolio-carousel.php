...
class POTW_PortfolioSliders extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Portfolio Carousel', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Select Categories', 'potw' ),
				...
				'placeholder' => __( 'All Categories', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Show Number Projects', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style1'  	=> __( 'Style 1', 'potw' ),

					'style2' 	=> __( 'Style 2', 'potw' ),

					'style3' 	=> __( 'Style 3', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Image Size', 'potw' ),

				'type' => Controls_Manager::SELECT,

				'default' => 'potw-slide-portfolio-thumbnail',

				'options' => [					

					'potw-slide-portfolio-thumbnail' 	=> __( 'Default - 800 x 557', 'potw' ),

					'potw-slide-portfolio-thumbnail-2' 	=> __( 'Default 2 - 600 x 680', 'potw' ),

					'medium_large' 						=> __( 'Medium Large - 768 x 0', 'potw' ),

					'large' 							=> __( 'Large - 1024 x 1024', 'potw' ),

					'full' 								=> __( 'Full', 'potw' ),

					'custom' 							=> __( 'Custom', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Image Dimension', 'potw' ),

				'type'  => Controls_Manager::IMAGE_DIMENSIONS,

				'description' => __( 'Crop the original image size to any custom size. Set custom width or height to keep the original size ratio.', 'potw' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'label' => __( 'Position Bottom Hover', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Background Overlay Hover', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_PortfolioSliders() );