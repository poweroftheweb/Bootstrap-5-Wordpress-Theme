...
class POTW_Service_Box extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Service Box', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					's1'  => __( 'Style 1: Gradient Number', 'potw' ),

					's2'  => __( 'Style 2: Has Shape', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Number/Icon Left', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Service_Box() );