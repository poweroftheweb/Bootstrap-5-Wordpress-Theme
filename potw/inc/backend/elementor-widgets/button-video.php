...
class POTW_VideoPopup extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Video Popup', 'potw' );
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_VideoPopup() );