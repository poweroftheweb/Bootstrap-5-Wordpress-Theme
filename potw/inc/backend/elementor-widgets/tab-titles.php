...
class POTW_Tab_Titles extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Tab Titles', 'potw' );
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'label' => __( 'Link to ID Content', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Background Active/Hover Box', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Tab_Titles() );