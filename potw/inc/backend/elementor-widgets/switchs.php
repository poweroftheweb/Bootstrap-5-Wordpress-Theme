...
class POTW_Switchs extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Select a Before Page', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Select a After Page', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Before Text Color', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Before DOT Color', 'potw' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Before DOT Box Shadow', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Before WRAPPER Background Color', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Before WRAPPER Border Color', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'After Text Color', 'potw' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'After DOT Box Shadow', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'After WRAPPER Background Color', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'After WRAPPER Border Color', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Switchs() );