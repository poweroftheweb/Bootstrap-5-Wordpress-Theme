...
class POTW_MessageBox extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Message Box', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Information Box', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'We help ambitious businesses like yours generate.', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_MessageBox() );