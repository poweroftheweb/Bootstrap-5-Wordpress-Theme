...
class POTW_Counter extends Widget_Base{
		...
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					's1'  => __( 'Number Top', 'potw' ),

					's2'  => __( 'Number Bottom', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Counter() );