...
class POTW_Accordions extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Accordion Title', 'potw' ),



				'placeholder' => __( 'Accordion Title', 'potw' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Accordion Content', 'potw' ),



				'placeholder' => __( 'Accordion Content', 'potw' ),
			...
			[
				...
				'default' => [
					...
					[
						...
						'acc_title' => __( 'Accordion #1', 'potw' ),



						'acc_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Accordions() );