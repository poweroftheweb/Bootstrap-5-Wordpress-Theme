...
class POTW_Circle_Process extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Circle Process', 'potw' );
	...
	protected function _register_controls() {
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'text-left'  => __( 'Text Left', 'potw' ),

					'text-right' => __( 'Text Right', 'potw' ),

					'text-center' => __( 'Text Center', 'potw' ),
		...
		$repeater->add_responsive_control(
			...
			[
				...
				'label' => __( 'Spacing between content and number', 'potw' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label' => __( 'Dot & Number Color', 'potw' ),
		...
		$repeater->add_group_control(
			...
			[
				...
				'label' => __( 'Box Shadow for Dot', 'potw' ),
			...
			[
				...
				'default' => [
					...
					[
						...
						'list_number' => __( '01', 'potw' ),

						'list_title' => __( 'Title #1', 'potw' ),

						'list_content' => __( 'Item content. Click the edit button to change this text.', 'potw' ),

					],

					[

						'list_number' => __( '02', 'potw' ),

						'list_title' => __( 'Title #2', 'potw' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'label' => __( 'Circle Width/Height', 'potw' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'label' => __( 'Circle Border Width', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Gradient Color 1', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Gradient Color 2', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Choose Logo Image', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Circle_Process() );