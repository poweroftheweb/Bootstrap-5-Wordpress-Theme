...
class POTW_Team extends Widget_Base{
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				...
				'label' => esc_html__( 'Member Team', 'potw' ),
	    ...
	    $this->add_control(
		    ...
		    'member_name',
	          ...
	          'default' => esc_html__( 'Jonathan Morgan', 'potw' ),
	    ...
	    $this->add_control(
		    ...
		    'member_extra',
	          ...
	          'default' => esc_html__( 'WEB Designer', 'potw' ),
		...
		$repeater->add_control(
		    ...
		    [
		        ...
		        'default' => esc_html__( 'Social', 'potw' ),
		    ...
		    [
		        ...
		        'default'     => [
		            ...
		            [
		             	...
		             	'title'       => esc_html__( 'Twitter', 'potw' ),

		                'social_link' => esc_html__( 'https://www.twitter.com/', 'potw' ),
		            ...
		            [
		             	...
		             	'title'       => esc_html__( 'Facebook', 'potw' ),

		                'social_link' => esc_html__( 'https://www.facebook.com/', 'potw' ),
		            ...
		            [
		             	...
		             	'title'       => esc_html__( 'Pinterest', 'potw' ),

		                'social_link' => esc_html__( 'https://www.pinterest.com/', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'label'     => esc_html__( 'Toggle Button Color', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Team() );