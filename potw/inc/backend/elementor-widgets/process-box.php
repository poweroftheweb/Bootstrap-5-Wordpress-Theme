...
class POTW_Process extends Widget_Base{
	...
	public function get_title() {
		...
		return __( 'POTW Process Box', 'potw' );
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Project Introduction', 'potw' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'We are a team of non-cynics who truly care for our work and for each other.', 'potw' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new POTW_Process() );